...
if __name__ == "__main__":
    ...
    with open(data_path, "w", encoding="utf-8") as data_file:
        ...
        for _ in range(0, 40):
            id_ = str(get_random_id(10000, 20000, 0.3)) + ","
            gen_ = str(random.choice(gender)) + ","
            age_ = str(get_random_age(24, 55, 0.3)) + ","
            d_ = str(random.choice(department)) + "\n"
            data_file.write(id_ + gen_ + age_ + d_)
